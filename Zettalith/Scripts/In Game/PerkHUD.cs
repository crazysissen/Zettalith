    ...
    class PerkHUD : HUD
    {
        ...
        public PerkHUD(GUI.Collection collection, InGameController igc, PlayerLocal p, ClientSideController csc) : base(igc, p, csc)
        {
            ...
            allPerks = new Perk[]
            {
                ...
                new Perk("Essence income 1", "Essence income \nis fastened", 0.5f, 0.35f, 1, Load.Get<Texture2D>("Bonus Shop Button"), 11, InGameController.PlayerIndex - 2, new Mana(), 0, csc, descriptionCollection),
                new Perk("Essence income 2", "Essence income \nis further \nfastened", 0.5f, 0.2f, 1, Load.Get<Texture2D>("Bonus Shop Button"), 11, InGameController.PlayerIndex - 2, new Mana(), 0, csc, descriptionCollection)
            };
