    ...
    class PerkHUD : HUD
    {
        ...
        public PerkHUD(GUI.Collection collection, InGameController igc, PlayerLocal p, ClientSideController csc) : base(igc, p, csc)
        {
            ...
            allPerks = new Perk[]
            {
                ...
                new Perk("Ability cost decrease", "The cost of all \nabilities in your \nhand and deck is \ndecreased by 30%", 0.7f, 0.3f, 1, Load.Get<Texture2D>("Ability Perk"), 4, -1, new Mana(), 0, csc, descriptionCollection),
                new Perk("Health increased", "The health of all \nZettaliths in your \nhand and deck is \nincreased by 50%", 0.3f, 0.7f, 1, Load.Get<Texture2D>("Health Perk"), 4, -1, new Mana(), 0, csc, descriptionCollection),
                new Perk("Movement increased", "The movement speed \nof all Zettaliths in \nyour hand and deck is \nincreased by 30%", 0.7f, 0.7f, 1, Load.Get<Texture2D>("Move Perk"), 4, -1, new Mana(), 0, csc, descriptionCollection),
                new Perk("Essence income 1", "Essence income is \nincreased by 30%", 0.5f, 0.35f, 1, Load.Get<Texture2D>("Bonus Shop Button"), 4, -1, new Mana(), 0, csc, descriptionCollection),
                new Perk("Essence income 2", "Essence income is \nincreased by another \n30%", 0.5f, 0.2f, 1, Load.Get<Texture2D>("Bonus Shop Button"), 4, -1, new Mana(), 0, csc, descriptionCollection)
            };
