    ...
    class PerkHUD : HUD
    {
        ...
        public PerkHUD(GUI.Collection collection, InGameController igc, PlayerLocal p, ClientSideController csc) : base(igc, p, csc)
        {
            ...
            allPerks = new Perk[]
            {
                ...
                new Perk("King Movement", "The move range \nof your king \nis increased \nby 1", 0.7f, 0.7f, 1, Load.Get<Texture2D>("Move Perk"), 11, InGameController.PlayerIndex - 2, new Mana(), 0, csc, descriptionCollection),
                new Perk("Essence income 1", "Essence income \nis fastened", 0.4f, 0.6f, 1, Load.Get<Texture2D>("Bonus Shop Button"), 12, InGameController.PlayerIndex - 2, new Mana(), 0, csc, descriptionCollection),
                new Perk("Essence income 2", "Essence income \nis further \nfastened", 0.3f, 0.7f, 1, Load.Get<Texture2D>("Bonus Shop Button"), 12, InGameController.PlayerIndex - 2, new Mana(), 0, csc, descriptionCollection)
            };
