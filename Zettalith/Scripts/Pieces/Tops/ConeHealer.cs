...
namespace Zettalith.Pieces
{
    ...
    {
        public override string Description { get => "Restores " + Modifier.StatChanges.Health + " health to Zettaliths in a cone"; protected set => throw new Exception("Cannot set overwritten Description property."); }
