...
namespace Zettalith
{
    static class Subpieces
    {
        ...
        public static List<Type> SubPieces = new List<Type>
        {
            ...
            typeof(DiagonalMan), typeof(StraightMan),  typeof(TestTop3), typeof(Duplicator), typeof(Teleporter), typeof(Queen), //typeof(Bottom2)
        };
        ...
        public static bool[] Unlocked = new bool[]
        {
            true, true, /*Tops*/
            true, true, /*Middles*/
            true, true, true, true, true, true, /*Bottoms*/
        };
